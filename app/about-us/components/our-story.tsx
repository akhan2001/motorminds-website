      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
            ...
            <p>
              What started as a simple idea to help auto shops has grown into a platform revolutionizing how businesses 
              and enthusiasts interact with the automotive industry. Together, we're building a community and a cutting-edge 
              solution that transforms operations, connects stakeholders, and empowers the future of automotive innovation.
            </p>
          </div>
        </div>
      </div>
