		...
		<section className="relative w-full py-24 overflow-hidden">
			...
			<div className="container relative z-20 mx-auto px-4 text-center">
				...
				<Link href="/contact-us">
					<Button className="bg-white hover:bg-red-500 hover:text-white text-black font-medium px-6 py-5 text-base rounded-full transition-all duration-300 cursor-pointer">
						Schedule a Demo
